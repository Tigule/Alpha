...
const char *__fastcall ChrClassesRec::GetFilename() {
...
bool ChrClassesRec::Read(SFile *f, const char *stringBuffer) {
  ...
  result = SFile::Read(f, &m_DamageBonusStat, sizeof(m_DamageBonusStat), 0, 0, 0) && result;
  result = SFile::Read(f, &m_DisplayPower, sizeof(m_DisplayPower), 0, 0, 0) && result;
  result = SFile::Read(f, &temppetNameTokenIndices[0], sizeof(temppetNameTokenIndices[0]), 0, 0, 0) && result;
