...
static int __fastcall CCommand_Trade(const char* command, const char* arguments) {
...
static int __fastcall CCommand_AddTradeItem(const char* command, const char* arguments) {
...
static int __fastcall CCommand_ClearTradeItem(const char* command, const char* arguments) {
...
static int __fastcall CCommand_ClearTrade(const char* command, const char* arguments) {
  if (ClntObjMgrObjectPtr(ClntObjMgrGetActivePlayer(), __FILE__, __LINE__)) {
...
static int __fastcall CCommand_AcceptTrade(const char* command, const char* arguments) {
  if (ClntObjMgrObjectPtr(ClntObjMgrGetActivePlayer(), __FILE__, __LINE__)) {
    Trade_C_AcceptTrade();
  }
  return 1;
...
static int __fastcall CCommand_CancelTrade(const char* command, const char* arguments) {
  if (ClntObjMgrObjectPtr(ClntObjMgrGetActivePlayer(), __FILE__, __LINE__)) {
    Trade_C_CancelTrade();
  }
  return 1;
...
static int __fastcall CCommand_ShowTrade(const char*, const char*) {
...
static int __fastcall CCommand_TradeGold(const char*, const char* arguments) {
  CDataStore msg;
...
static int __fastcall CCommand_UnacceptTrade(const char*, const char*) {
  Trade_C_UnacceptTrade();
  return 1;
}

static int __fastcall TradeStatusHandler(void*, NETMESSAGE, unsigned long, CDataStore* netmsg) {
  unsigned int status;
  netmsg->Get(status);
