...
void CGContainerInfo::UpdateContents(DWORDLONG guid) {
...
void CGContainerInfo::OpenContainer(DWORDLONG container) {
...
void CGContainerInfo::UpdateItem(DWORDLONG item) {
