   ...
   public:
    ...
    explicit C34Matrix(float value)
        : a0(value), a1(value), a2(value), b0(value), b1(value), b2(value),
          c0(value), c1(value), c2(value), d0(value), d1(value), d2(value) {
    }
    C34Matrix(const C33Matrix &m)
        : a0(m.a0), a1(m.a1), a2(m.a2), b0(m.b0), b1(m.b1), b2(m.b2),
          c0(m.c0), c1(m.c1), c2(m.c2), d0(0.0f), d1(0.0f), d2(0.0f) {
    }
    C34Matrix(const C3Vector &a, const C3Vector &b, const C3Vector &c)
        : a0(a.x), a1(a.y), a2(a.z), b0(b.x), b1(b.y), b2(b.z),
          c0(c.x), c1(c.y), c2(c.z), d0(0.0f), d1(0.0f), d2(0.0f) {
    }
    C34Matrix(const C3Vector &a, const C3Vector &b, const C3Vector &c, const C3Vector &d)
        : a0(a.x), a1(a.y), a2(a.z), b0(b.x), b1(b.y), b2(b.z),
          c0(c.x), c1(c.y), c2(c.z), d0(d.x), d1(d.y), d2(d.z) {
    }
    ...
    C3Vector Row0() const { return C3Vector(a0, a1, a2); }
    C3Vector Row1() const { return C3Vector(b0, b1, b2); }
    C3Vector Row2() const { return C3Vector(c0, c1, c2); }
    C3Vector Row3() const { return C3Vector(d0, d1, d2); }
